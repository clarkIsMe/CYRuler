...
- (void)setPointer:(UIView *)pointer {
    ...
    CGRect frame = [self convertRect:CGRectMake(1, self.rulerModel.pointerOffset-orginframe.size.height/2.0, orginframe.size.width, orginframe.size.height) toView:self.superview];
    pointer.frame = frame;
